...
if (current_habit_is_negative()) {
    ...
    correct_goal_text.innerHTML = "Тут будет текст про позитивную привычку. Тут будет текст про позитивную привычку. Тут будет текст про позитивную привычку. Тут будет текст про позитивную привычку. Тут будет текст про позитивную привычку. Тут будет текст про позитивную привычку. Тут будет текст про позитивную привычку.";
}
