...
if (current_habit_is_negative()) {
    ...
    trigger_factors_text.textContent = "Далее в течение недели вы будете исследовать ситуации, в которых вам, скорее всего, будет особенно трудно начать и выполнять новую привычку. Это поможет заранее распознать возможные препятствия и подготовиться к ним.";
}
