...
export let test_2 = {
    question_1: {
        question_text: "Я искал(а) информацию о проблеме своего поведения.",
        options: {
            option_1: "Да",
            option_2: "Скорее, да",
            option_3: "Скорее, нет",
    ...
    question_2: {
        question_text: "Я размышлял(а) о том, что прочитал(а) в статьях и книгах, и о том, как преодолеть мои проблемы.",
        options: {
            option_1: "Да",
            option_2: "Скорее, да",
            option_3: "Скорее, нет",
    ...
    question_3: {
        question_text: "Я вспомнил(а), что говорили мне люди о преимуществах изменения моего поведения.",
        options: {
            option_1: "Да",
            option_2: "Скорее, да",
            option_3: "Скорее, нет",
